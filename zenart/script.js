...
const items = [
{
  key: '1',
  artist: 4,
  image: 'img/nft-03.jpg',
  price: '100',
  title: 'Stellar Ledger of ZenChain',
  timeLeft: 84670923 },

{
  key: '2',
  artist: 2,
  image: 'img/nft-04.jpg',
  price: '125',
  title: 'Cosmic Blocks of the ZenChain Galaxy',
  timeLeft: 12873491 },

{
  key: '3',
  artist: 0,
  image: 'img/nft-01.jpg',
  price: '150',
  title: 'ZenChain Galaxy Hashes Expedition',
  timeLeft: 84720185 },

{
  key: '4',
  artist: 3,
  image: 'img/nft-02.jpg',
  price: '135',
  title: 'Aurora Protocol: A ZenChain Journey',
  timeLeft: 43826185 },

{
  key: '5',
  artist: 2,
  image: 'img/nft-05.jpg',
  price: '115',
  title: 'Interstellar Blocks Across the ZenChain Universe',
  timeLeft: 134627 },

{
  key: '6',
  artist: 1,
  image: 'img/nft-06.jpg',
  price: '150',
  title: 'Infinite Chainverse of ZenChain Stars',
  timeLeft: 12008745 }];
...
function SidebarRight() {
  return /*#__PURE__*/(
    ...
    React.createElement("h2", { className: "text-white font-semibold" }, "Buy a collection with ZenChain"), /*#__PURE__*/


    React.createElement("p", { className: "text-white/50 text-sm mt-1 " }, "you can buy a collection of artwork with ZenChain very easy and simple"), /*#__PURE__*/
...
function Items() {
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: "" }, price, " ZTC")), /*#__PURE__*/
...
function Content() {
  return /*#__PURE__*/(
    ...
    React.createElement("h2", { className: "text-zinc-500 px-3" }, "Discover, trade, and showcase unique digital art, NFT collection on the ZenChain"), /*#__PURE__*/
...
function Header() {
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: "w-10 h-10 bg-gradient-to-tr from-fuchsia-600 to-violet-600 grid place-items-center rounded-full font-bold text-white  text-2xl" }, "Z"), /*#__PURE__*/


    React.createElement("div", { className: "ml-2 font-bold text-xl" }, "ZenART")), /*#__PURE__*/
